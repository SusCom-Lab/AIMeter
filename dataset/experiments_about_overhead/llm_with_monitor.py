...
try:
    monitor.start(task_name = "prefill_decode_batch_size_2", sampling_interval = 1, output_format = "csv", additional_metrics=['Gdetails','CPU','DRAM','fp64','fp32','fp16'], indices=[0], position=(37,-122))
